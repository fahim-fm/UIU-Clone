...
<html lang="en">
  <head>
    ...
    <link
      rel="icon"
      type="image/png"
      href="image/United_International_University_Monogram.svg.png"
    />
    ...
    <section class="research-section">
      <div class="container">
        ...
        <div class="research-logo">
          <img
            src="image/default_image_uiu-e1709026264995.jpg"
            alt="UIU Logo"
          />
        </div>
        ...
        <div class="academic-stats">
          ...
          <div class="stat-box">
            <h2>100+</h2>
            <p>Crore Taka Funded Projects</p>
          </div>
        </div>
        ...
        <div class="research-block">
          ...
          <p class="research-description">
            ...
            intellectual, creative, technical, moral and practical skills to
            serve community, industry and region.
          </p>
          <div class="research-flex">
            <img src="image/r1.jpg" alt="Journal Paper" />
            <div class="research-text-box">
              <h3>List of Journal Paper</h3>
              <p>
                The mission of UIU is to create excellent human resources with
                intellectual, creative, technical, moral and practical skills to
                serve community, industry and region. The mission of UIU is to
                create excellent human resources...
              </p>
              <a href="#" class="btn-orange">Explore All Journal Papers</a>
            </div>
          </div>
        </div>
        ...
        <div class="research-block">
          ...
          <div class="research-flex reverse">
            <div class="research-text-box">
              <h3>List of Conference Papers</h3>
              <p>
                The mission of UIU is to create excellent human resources with
                intellectual, creative, technical, moral and practical skills to
                serve community, industry and region. The mission of UIU is to
              ...
              <a href="#" class="btn-orange">Explore All Conference Papers</a>
            </div>
            <img src="image/r2.jpg" alt="Conference Paper" />
          </div>
        </div>
      </div>
    </section>
